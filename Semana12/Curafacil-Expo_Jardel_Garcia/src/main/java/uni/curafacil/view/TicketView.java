...
public class TicketView extends javax.swing.JFrame {
     ...
     * @param nTicket
     */
    public TicketView(String Cajero, String nCliente, String nTicket, String productos[][], String total) {
        initComponents();
        java.util.Date fecha = new java.util.Date();
        String fechaActual = fecha.toString();
        try{
            VentasController.generateTicket(nCliente, Cajero, fechaActual, nTicket, productos, total, jTextArea1);
        } catch (Exception ex) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        VentasController.printTicket(jTextArea1);

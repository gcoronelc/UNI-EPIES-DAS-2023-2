...
public class PoSView extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        /**
         * TODO: Modificar para que aparezca tablas de medicamentos Recetas re =
         * new Recetas(); re.setVisible(true);
         *
         * re.addWindowListener(new WindowAdapter(){
         *
         * @Override public void windowClosed(WindowEvent we) { Object[] rowData
         * = re.getSelectedRowData(); BigDecimal bigDecimalValue = (BigDecimal)
         * rowData[0]; double doubleValue = bigDecimalValue.doubleValue();
         *
         * Object[] depurado; depurado = new Object[] { rowData[1], 1.0,
         * doubleValue, doubleValue };
         *
         * DefaultTableModel model = (DefaultTableModel) tProductos.getModel();
         * model.addRow(depurado); actualizarTotales(); } });*
         */
        ...
        productosView.addWindowListener(new WindowAdapter() {
            @Override
            public void windowClosed(WindowEvent we) {
                Object[] rowData = productosView.getSelectedRowData();

                // Verificar si el valor en rowData[2] es BigDecimal
                if (rowData[2] instanceof BigDecimal) {
                    BigDecimal bigDecimalValue = (BigDecimal) rowData[2];
                    ...
                    // Manejar el caso en el que rowData[2] no es BigDecimal
                    // Puedes mostrar un mensaje de error, lanzar una excepción, o realizar otra acción adecuada.
                    System.err.println("Error: El valor en rowData[2] no es un BigDecimal.");
                }
            }
        });
